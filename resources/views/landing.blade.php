...
<link rel='stylesheet' href='{{asset('/blog/css/woocommerce-layout.css')}}' type='text/css' media='all'/>
<link rel='stylesheet' href='{{asset('/blog/css/woocommerce-smallscreen.css')}}' type='text/css' media='only screen and (max-width: 768px)'/>
<link rel='stylesheet' href='{{asset('/blog/css/woocommerce.css')}}' type='text/css' media='all'/>
<link rel='stylesheet' href='{{asset('/blog/css/font-awesome.min.css')}}' type='text/css' media='all'/>
<link rel='stylesheet' href='{{asset('/blog/css/style.css')}}' type='text/css' media='all'/>
<link rel='stylesheet' href='https://fonts.googleapis.com/css?family=Oswald:400,500,700%7CRoboto:400,500,700%7CHerr+Von+Muellerhoff:400,500,700%7CQuattrocento+Sans:400,500,700' type='text/css' media='all'/>
<link rel='stylesheet' href='{{asset('/blog/css/easy-responsive-shortcodes.css')}}' type='text/css' media='all'/>
</head>
	...
	<div class="container">
		...
		<div class="menu-menu-1-container">
			<ul id="menu-menu-1" class="menu">
				...
				<li><a href="blog.html">مقالات وبلاگ</a>
                                <ul class="sub-menu">
					...
					<li><a href="portfolio-category.html">Portfolio Category</a></li>
                                ...
                                @guest
                                    <li><a href="index.html">ورود /عضویت</a></li>                                
                                @else
                                    <li><a href="index.html">{{auth()->user()->name}}</a></li>
                                @endguest
